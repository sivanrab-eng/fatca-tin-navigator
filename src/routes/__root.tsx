...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "מצא את שם ומבנה מספר זיהוי המס (TIN) בכל מדינה — ליחיד ולחברה, כולל היכן ניתן למצוא אותו, לצורכי FATCA/CRS." },
      { name: "theme-color", content: "#0a0a0a" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "מאתר TIN — FATCA/CRS" },
